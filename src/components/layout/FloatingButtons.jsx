  ...
  if (isMobile) {
    return (
      <div className={`mobile-sticky-bar ${isVisible ? 'visible' : ''}`}>
        <a href="tel:+919822262526" className="mobile-sticky-bar__btn mobile-sticky-bar__btn--call">
        ...
        <a 
          ...
          className="mobile-sticky-bar__btn mobile-sticky-bar__btn--whatsapp"
          target="_blank"
        ...
        <a 
          ...
          className="mobile-sticky-bar__btn mobile-sticky-bar__btn--map"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
